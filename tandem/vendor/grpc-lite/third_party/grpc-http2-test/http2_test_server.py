...
# Modified by grpc-lite in 2026 for Python 3 compatibility and loopback binding.
"""HTTP2 Test Server"""
...
class H2Factory(twisted.internet.protocol.Factory):
    ...
    def buildProtocol(self, addr):
        ...
        if self._testcase not in _TEST_CASE_MAPPING:
...
def start_test_servers(host, base_port):
    ...
    for test_case in sorted(_TEST_CASE_MAPPING.keys()):
        ...
        endpoint = twisted.internet.endpoints.TCP4ServerEndpoint(
            twisted.internet.reactor, portnum, backlog=128, interface=host
        )
...
if __name__ == "__main__":
    ...
    start_test_servers(args.host, args.base_port)
