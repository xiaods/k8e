...
# Modified by grpc-lite in 2026 for Python 3 compatibility.
...
class H2ProtocolBaseServer(twisted.internet.protocol.Protocol):
    ...
    def dataReceived(self, data):
        ...
        for event in events:
            if (
                isinstance(event, h2.events.RequestReceived)
                ...
                isinstance(event, h2.events.PingAcknowledged)
