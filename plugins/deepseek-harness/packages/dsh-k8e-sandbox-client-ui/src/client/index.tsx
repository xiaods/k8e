...
const zh = {
  ...
  'status.noGrpc': '未配置 gRPC（终端需要显式 endpoint）。刚运行过 k8e-sandbox-cli connect 的话请重启 dsh。',
  'status.cwd': '工作目录',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'status.noGrpc': 'gRPC not configured (terminal needs an explicit endpoint). If you just ran k8e-sandbox-cli connect, restart dsh.',
