...
download_and_setup() {
    ...
    $SUDO curl https://raw.githubusercontent.com/xiaods/k8e/master/contrib/k8e-start-server.sh -o k8e-start-server.sh && \
    $SUDO  chmod +x k8e-start-server.sh

    $SUDO curl https://raw.githubusercontent.com/xiaods/k8e/master/contrib/k8e-start-agent.sh -o k8e-start-agent.sh &&  \
    $SUDO chmod +x k8e-start-agent.sh

    $SUDO curl https://raw.githubusercontent.com/xiaods/k8e/master/contrib/k8e-stop.sh -o k8e-stop.sh && \
    $SUDO  chmod +x k8e-stop.sh

    $SUDO curl https://raw.githubusercontent.com/xiaods/k8e/master/contrib/k8e-killall.sh -o k8e-killall.sh && \
    $SUDO   chmod +x k8e-killall.sh

    $SUDO curl https://raw.githubusercontent.com/xiaods/k8e/master/contrib/k8e-uninstall.sh -o k8e-uninstall.sh && \
    $SUDO  chmod +x k8e-uninstall.sh
