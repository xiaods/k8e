...
func (k *k8e) Register(ctx context.Context,
...
func (k *k8e) ensureServiceLBNamespace(ctx context.Context) error {
...
func (k *k8e) ensureServiceLBServiceAccount(ctx context.Context) error {
...
func (k *k8e) onChangePod(key string, pod *core.Pod) (*core.Pod, error) {
	if pod == nil {
		return nil, nil
	}
...
func (k *k8e) onChangeNode(key string, node *core.Node) (*core.Node, error) {
	if node == nil {
		return nil, nil
	}
...
func (k *k8e) onChangeEndpointSlice(key string, eps *discovery.EndpointSlice) (*discovery.EndpointSlice, error) {
	if eps == nil {
		return nil, nil
	}
...
// to be serviced.
func (k *k8e) processNextWorkItem() bool {
...
func (k *k8e) processSingleItem(obj interface{}) error {
	var (
		key string
		ok  bool
	)
...
func (k *k8e) updateStatus(namespace, name string) error {
...
func (k *k8e) getDaemonSet(svc *core.Service) (*apps.DaemonSet, error) {
...
func (k *k8e) getStatus(svc *core.Service) (*core.LoadBalancerStatus, error) {
...
func (k *k8e) patchStatus(svc *core.Service, previousStatus, newStatus *core.LoadBalancerStatus) error {
...
func (k *k8e) podIPs(pods []*core.Pod, svc *core.Service, readyNodes map[string]bool) ([]string, error) {
...
func (k *k8e) deployDaemonSet(ctx context.Context, svc *core.Service) error {
...
func (k *k8e) deleteDaemonSet(ctx context.Context, svc *core.Service) error {
...
// each eligible node.
func (k *k8e) newDaemonSet(svc *core.Service) (*apps.DaemonSet, error) {
	name := generateName(svc)
...
func (k *k8e) updateDaemonSets() error {
	enableNodeSelector, err := k.nodeHasDaemonSetLabel()
	if err != nil {
		return err
	}
...
// will be used.
func (k *k8e) nodeHasDaemonSetLabel() (bool, error) {
...
func (k *k8e) deleteAllDaemonsets(ctx context.Context) error {
...
func (k *k8e) removeServiceFinalizers(ctx context.Context) error {
...
func (k *k8e) removeFinalizer(ctx context.Context, svc *core.Service) (*core.Service, error) {
	var found bool
