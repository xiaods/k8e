...
import (
	...
	"github.com/xiaods/k8e/pkg/agent/netpol/utils"
...
// The NewNetworkPolicyController function has also been modified to use the k8e config.Node struct instead of KubeRouter's
