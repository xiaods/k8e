...
func (c *FakeAddons) UpdateStatus(ctx context.Context, addon *k8ecattleiov1.Addon, opts v1.UpdateOptions) (*k8ecattleiov1.Addon, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(addonsResource, "status", c.ns, addon), &k8ecattleiov1.Addon{})
