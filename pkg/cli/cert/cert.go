...
func rotate(app *cli.Context, cfg *cmds.Server) error {
	...
	for _, service := range cmds.ServicesList {
		...
		case version.Program + k8eServerService:
		...
		case version.Program + programControllerService:
			fileList = append(fileList,
				serverConfig.ControlConfig.Runtime.ClientK8eControllerCert,
				serverConfig.ControlConfig.Runtime.ClientK8eControllerKey,
